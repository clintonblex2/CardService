...
{
    /// <inheritdoc />
    public partial class AddedUsersAndCardTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "datetime2", maxLength: 40, nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", maxLength: 40, nullable: true),
